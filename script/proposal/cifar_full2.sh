...
SEED=2024
GPU=0
ROOT=/mnt/disk4/namnp/DeYO/DATA/
LRMUL=1

INTERVAL=30
BATCH=64
MODEL=resnet18_bn
PRETRAINED=/mnt/disk4/namnp/DeYO/pretrained/CIFAR10_model_update.pickle
EXP_TYPE=normal
#EATA
EATA_FISHERS=1
FISHER_SIZE=2000
...
for LEVEL in $(seq 4 5)
do
    OUTPUT=/mnt/disk4/namnp/DeYO/output/cifarC/baseline/level_$LEVEL/jpeg_compression/
...
#     #Propose
    ...
    END=0.95
    STEP=0.05
    OUTPUT=/mnt/disk2/namnp/DeYO/output/cifarC/level_$LEVEL/jpeg_compression/
