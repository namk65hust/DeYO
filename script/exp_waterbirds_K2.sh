...
python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.1 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.15 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.2 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.25 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.3 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.35 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.4 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.45 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.5 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.55 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.6 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.65 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.7 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.75 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.8 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.85 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.9 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra

python3 ../main_update.py --method eata --dset $DSET --wandb_interval $INTERVAL --deyo_margin $ETHR --deyo_margin_e0 $EMAR --plpd_threshold $DTHR --lr_mul $LRMUL --exp_type spurious --model $MODEL --seed $SEED --num_sim $NUM_SIM  --alpha_cap 0.95 --gpu $GPU --pretrained_path $PRETRAINED --output ../output_waterbird_extra
